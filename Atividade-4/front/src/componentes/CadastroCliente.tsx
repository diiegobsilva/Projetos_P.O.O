                ...
                <div className="row">
                    <form className="col s12" onSubmit={(e) => this.submeterFormulario(e)}>
                        ...
                        <div className="col s2">
                            <button className="btn waves-effect waves-light"  type="submit" name="action">Cadastrar Cliente
                                <i className="material-icons right">send</i>
                            </button>
                        </div>
                        <div className="col s6">
                            <Link to="/formularioCadastroProduto">
                                <button className="btn waves-effect waves-light"  name="action">Voltar
                                    <i className="material-icons right">send</i>
                                </button>
                            </Link>
