            ...
            <div>
                ...
                <div className='container'>
                    <div className="collection">
                        <a className="collection-item" href="/clientes">Cliente 1</a>
                        <a className="collection-item" href="/clientes">Cliente 2</a>
                        <a className="collection-item" href="/clientes">Cliente 3</a>
                    </div>
                </div>
            </div>
