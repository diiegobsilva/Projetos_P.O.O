            ...
            <div>
                ...
                <div className='container'>
                    <div className="collection">
                        <a className="collection-item" href="/produtos">Produto 1</a>
                        <a className="collection-item" href="/produtos">Produto 2</a>
                        <a className="collection-item" href="/produtos">Produto 3</a>
                    </div>
                </div>
            </div>
        )
