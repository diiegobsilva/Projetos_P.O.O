            ...
            switch (opcao) {
                case 1:
                    ...
                    consumoProduto.forEach( cliente => {
                        console.log(chalk.greenBright('Nome do Cliente: ') + cliente.nome );
                        console.log(chalk.greenBright('CPF do Cliente: ') + cliente.cpf );
                        console.log(chalk.greenBright('Quantidade de Produtos Consumidos pelo Cliente: ') + cliente.quantidadeProdutos );
                ...
                case 2:
                    ...
                    consumoServico.forEach( cliente => {
                        console.log(chalk.greenBright('Nome do Cliente: ') + cliente.nome  );
                        console.log(chalk.greenBright('CPF do Cliente: ') + cliente.cpf  );
                        console.log(chalk.greenBright('Quantidade de Serviços Consumidos pelo Cliente: ') + cliente.quantidadeServicos );
